...
function Pastes() {
  ...
  return (
    <div className="w-full py-4 px-3 flex flex-col justify-between items-stretch">
      ...
      <div className="border-2 border-white/20 outline-none text-white px-2 py-3 w-full rounded-md transition-all custom-scrollbar min-h-[58vh] sm:min-h-[67vh] bg-gray-950/20 flex flex-col gap-3 shadow-xl">
        {allPastes.map((p) => (
          <div
            key={p.id}
            ...
            <div className="flex flex-col gap-2 items-start sm:items-end justify-between">
              <div className="py-1">
                <ul className="flex gap-2 font-bold">
                  <li className="border px-1 py-1 rounded">
                    <Link to={`/paste/${p.id}`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="size-4 cursor-pointer hover:text-green-500 transition-colors"
                      >
                  ...
                  <li className="border px-1 py-1 rounded">
                    <button
                      ...
                      onClick={() => dispatch(removePaste(p.id))}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                    ...
                    >
                      {copyId === p.id ? (
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          className="size-4 text-green-500 transition-colors"
                        >
                          <path
                            fillRule="evenodd"
              ...
              <div>
                <p className="text-xs sm:text-sm flex gap-1.5 font-bold whitespace-nowrap">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
